...
var Trigger = function (_Component) {
	...
	_createClass(Trigger, [{
		...
		value: function renderCalendar() {
			...
			var inputHeight = _state.inputHeight;
			var _props2 = this.props;
			var target = _props2.target;
			var wrapStyle = _props2.wrapStyle;

			if (showCalendar && target) {
				var _target$props = target.props;
				var confirm = _target$props.confirm;
				var onConfirm = _target$props.onConfirm;
				var onChange = _target$props.onChange;
