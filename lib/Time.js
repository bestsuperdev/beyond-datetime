...
var Time = function (_Component) {
	...
	function Time(props) {
		...
		date = (0, _parseInput.parseTimeInput)(date, format, true);
	...
	_createClass(Time, [{
		...
		value: function render() {
			...
			var hour = _props2.hour;
			var minute = _props2.minute;
			var second = _props2.second;
			...
			return _react2['default'].createElement(
				'div',
				{ className: _consts.timePrefix, style: { width: this.getWidth() } },
				...
				confirm && _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'a',
						{ href: '#', onClick: this.handlerConfirm.bind(this), className: _consts.timePrefix + '-confirm-btn' },
						'\u786E\u5B9A'
					)
				)
			);
