...
var Calendar = function (_Component) {
  ...
  _createClass(Calendar, [{
    ...
    key: 'handlerSelect',
    value: function handlerSelect(newDate, type) {
    ...
    value: function renderDays() {
      ...
      var isInvalid = _props6.isInvalid;
      ...
      return days.map(function (data, index) {
        ...
        return _react2['default'].createElement(_DayCell2['default'], _extends({
          onSelect: _this2.handlerSelect.bind(_this2)
        }, data, {
          // theme={ styles }
          //用于范围选择
    ...
    value: function renderTime() {
      ...
      var hour = _props7.hour;
      var minute = _props7.minute;
      var second = _props7.second;
      var timeConfirm = _props7.timeConfirm;

      if (time) {
        return _react2['default'].createElement(
          'div',
          { style: { position: 'relative' } },
          _react2['default'].createElement(_Time2['default'], { date: this.state.date, hour: hour, minute: minute, second: second, onChange: this.handlerSelect.bind(this) }),
          timeConfirm && _react2['default'].createElement(
            'a',
            { href: '#', onClick: this.handlerConfirm.bind(this), className: _consts.calendarPrefix + '-confirm-btn' },
            '\u786E\u5B9A'
          )
        );
      }
