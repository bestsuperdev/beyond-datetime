...
var Calendar = function (_Component) {
	...
	(0, _createClass3['default'])(Calendar, [{
		...
		value: function renderMonthAndYear() {
			...
			var years = [];
			var months = language === 'cn' ? DateHelper.Months : DateHelper.GlobalMonths;
		...
		value: function renderWeekdays() {
			...
			var weeks = language === 'cn' ? DateHelper.Weeks : DateHelper.GlobalWeeks;
			return _react2['default'].createElement(
				'div',
		...
		value: function renderBtns() {
			...
			var texts = DateHelper.languages[language];
			var btns = [];
			if (today) {
