...
var Calendar = function (_Component) {
	...
	function Calendar(props, context) {
		...
		var rangeKey = props.rangeKey;
		var offset = props.offset;
		var firstDayOfWeek = props.firstDayOfWeek;
		var time = props.time;
		var timeDate = props.timeDate;
		// console.log(date)
		// date = 
	...
	_createClass(Calendar, [{
		...
		value: function componentWillReceiveProps(nextProps) {
			...
			var timeDate = nextProps.timeDate;
		...
		value: function handlerDateSelect(newDate, type) {
			...
			var onConfirm = _props3.onConfirm;
			var onDateChange = _props3.onDateChange;
			var time = _props3.time;
			var second = _props3.second;
		...
		value: function handlerTimeSelect(newDate, type) {
			...
			var onTimeChange = _props4.onTimeChange;
			// let result = null
