...
var DateRange = function (_Component) {
	...
	function DateRange(props, context) {
		...
		_this.state = { startDate: startDate, endDate: endDate, startShownDate: startShownDate, endShownDate: endShownDate };
		_this.step = 0;
		return _this;
	}
	...
	_createClass(DateRange, [{
		...
		value: function handlerShownChange(prefix, date) {
			this.setState(_defineProperty({}, prefix + 'ShownDate', date));
		}
	}, {
		key: 'render',
